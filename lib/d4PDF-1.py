...
if __name__ == '__main__':
    ...
    url = 'http://' + host + '/download.cgi'

    usage ='''usage: %prog [options] file ...'''
    version='%prog 21.0428'
    parser = optparse.OptionParser(usage=usage, version=version)
    parser.add_option('-o', '--output', help='specify the output file', metavar='FILE')
    parser.add_option('-n', '--netrc', default=None, help='specify the netrc file', metavar='FILE')
    parser.add_option('-u', '--user', default=None, help='specify the DIAS account name', metavar='USERNAME')
